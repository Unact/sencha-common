 ...
 * created by extending {@link Ext.lib.grid.filter.Filter}.
 *
 ...
 *     grid.filters
 */
Ext.define('Ext.lib.grid.FiltersFeature', {
    extend: 'Ext.grid.feature.Feature',
    alias: 'feature.filters',
    uses: [
        'Ext.lib.grid.menu.ListMenu',
        'Ext.lib.grid.menu.RangeMenu',
        'Ext.lib.grid.filter.BooleanFilter',
        'Ext.lib.grid.filter.DateFilter',
        'Ext.lib.grid.filter.DateTimeFilter',
        'Ext.lib.grid.filter.ListFilter',
        'Ext.lib.grid.filter.NumericFilter',
        'Ext.lib.grid.filter.StringFilter'
    ],
     ...
     * @param {Object/Ext.lib.grid.filter.Filter} config A filter configuration or a filter object.
     * @return {Ext.lib.grid.filter.Filter} The existing or newly created filter object.
     */
     ...
     * @return {Ext.lib.grid.filter.Filter}
     */
     ...
     * @return {Function} The Ext.lib.grid.filter.Class
     */
